 ...
 */
class RespuestaEnvio extends Documento
{
    ...
    public function generar()
    {
        ...
        if (!isset($this->respuesta_envios[0]) and !isset($this->respuesta_documentos[0])) {
            Log::write(
                Estado::RESPUESTAENVIO_FALTA_RESPUESTA,
                Estado::get(Estado::RESPUESTAENVIO_FALTA_RESPUESTA)
            );
            return false;
        }
        ...
        if (!$this->caratula) {
            Log::write(
                Estado::RESPUESTAENVIO_FALTA_CARATULA,
                Estado::get(Estado::RESPUESTAENVIO_FALTA_CARATULA)
            );
            return false;
        }
        ...
        $xmlEnvio = (new XML())->generate($arreglo)->saveXML();
