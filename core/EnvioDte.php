...
{
    public $dtes = []; ///< Objetos con los DTE que se enviarán
    ...
    public function setCaratula(array $caratula)
    {
        ...
        $this->caratula = array_merge([
            ...
            'RutReceptor' => '60803000-K',  //Cambiar a rut Sii para certificación y producción.
            'FchResol' => '',
            'NroResol' => '',
    ...
    public function generar()
    {
        ...
        $this->xml_data = $this->Firma ? $this->Firma->signXML($xml, '#DTECHILE', 'SetDTE', true) : $xml;
        return $this->xml_data;
    }
