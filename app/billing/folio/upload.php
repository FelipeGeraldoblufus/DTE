...
$carpeta = $Directorio->creaDirectorio(__ROOT__.'/client/folio/'.$tf);
...
$datos = [$actual, $desde, $hasta, $vence, $ruta, $rut, $tipo];

$addFolio = $Folio->newFolio($datos); //cambios antes estaba $addFolio = $Folio->newFolio($actual, $desde, $hasta, $vence, $ruta, $rut, $tipo);
