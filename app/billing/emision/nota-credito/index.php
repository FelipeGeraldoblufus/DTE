...
<html lang="es">
  <head>
    <title>DTE Chile | Nota de Crédito</title>
    <!-- BEGIN META -->
    <meta charset="utf-8">
  ...
  <body class="menubar-hoverable header-fixed full-content">
        ...
        <section>
          ...
          <div class="section-body">
            <div class="col-lg-offset-1 col-md-11 col-sm-12">
              <div class="card">
                <div class="card-body">
                  <form class="form-horizontal" action="../generar.php" method="post" autocomplete="off">
                    <div class="shadow">
                      <br/>
                      <br/>
                      <div class="row">
                        <input type="hidden" name="TipoDTE" value="61">
                        ...
                        <div class="col-xs-6 col-sm-3 col-sm-push-6 text-center">
                          <div class="well well-sm">
                            ...
                            <input type="hidden" name="rutaFolio" value="<?php echo 'client/folio/61/61.xml' ?>">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h5 class="panel-title">DATOS EMISOR</h5>
                      </div>
                      <div class="panel-body">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group input-group-sm">
                              <input type="text" class="form-control" name="Telefono" placeholder="Teléfono" value="<?php echo $datos['telefono']?>"/>
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group input-group-sm">
                    ...
                    <!-- Panel Datos Receptor -->
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <div class="row">
                          <div class="col-sm-8">
                            <h5 class="panel-title">DATOS RECEPTOR</h5>
                          </div>
                          <div class="col-sm-4">
                        ...
                        <div class="row">
                          <div class="col-sm-4 text-center">
                            <div class="input-group input-group-sm">
                              ...
                              <input type="date" name="FchEmis" class="form-control" maxLength="10" value="<?php echo date('Y-m-d') ?>" required>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        <div id="item">
                          <div class="row">
                            <div class="col-sm-2">
                              <div class="form-group input-group-sm">
                                <input type="text" class="form-control" name="item[0][VlrCodigo]" id="codProducto0" placeholder="Código"/>
                              </div>
                            </div>
                            <div class="col-sm-10">
                              <div class="form-group input-group-sm">
                          ...
                          <div class="row">
                            <div class="col-sm-2">
                              <div class="form-group input-group-sm">
                                <input type="number" max="999999999999" maxlength="12" class="form-control" name="item[0][QtyItem]" placeholder="Cantidad"/>
                              </div>
                            </div>
                            <div class="col-sm-2">
                              <div class="form-group input-group-sm">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group input-group-sm text-center">
                            <button type="button" class="btn ink-reaction btn-primary" id="agregar_item">Agregar Línea de Detalle</button>
                            <button type="button" class="btn ink-reaction btn-warning hidden" id="quitar_item">Remover Línea de Detalle</button>
                          </div>
                        </div>
                      </div>
                    </div>

                    <!-- Panel Referencias (siempre visible para NC) -->
                    <div class="panel panel-default" id="panel_referencias">
                      <div class="panel-heading">
                      ...
                      <div class="panel-body">
                        <div id="refe">
                          <div class="row">
                            <div class="col-sm-4">
                              <div class="form-group input-group-sm">
                                <select name="refe[0][TpoDocRef]" class="form-control" required>
                                  <option value="">Seleccione Tipo Documento de Referencia</option>
                                  <option value="33">Factura Electrónica</option>
                                  <option value="34">Factura No Afecta Electrónica</option>
                                  ...
                                  <option value="56">Nota Débito Electrónica</option>
                            ...
                            <div class="col-sm-4">
                              <div class="form-group input-group-sm">
                                <input type="text" class="form-control" name="refe[0][FolioRef]" placeholder="Folio de Referencia" required/>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="input-group input-group-sm">
                                <label class="input-group-addon">Fecha Referencia</label>
                                <input type="date" class="form-control" name="refe[0][FchRef]" value="<?php echo date('Y-m-d')?>" required>
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-sm-12">
                              <div class="form-group input-group-sm">
                                <select name="refe[0][CodRef]" class="form-control" required>
                                  <option value="">Seleccione Codigo de la Referencia</option>
                                  <option value="1">(1) Anula Documento de Referencia</option>
                                  <option value="2">(2) Corrige Texto Documento de Referencia</option>
                                  <option value="3">(3) Corrige Montos Documento de Referencia</option>
                                </select>
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-sm-12">
                              <div class="form-group input-group-sm">
                                <input type="text" name="refe[0][RazonRef]" class="form-control" placeholder="Razón de la Referencia de acuerdo al codigo" required/>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h5 class="panel-title">CEDIBLE</h5>
                      </div>
                      <div class="panel-body">
                        <div class="col-sm-12">
                          <label class="radio-inline radio-styled">
                            <input type="radio" name="cedible" value="true"><span>Crear Cedible</span>
                          </label>
                          <label class="radio-inline radio-styled">
                            <input type="radio" name="cedible" value="false" checked><span>Sin Cedible</span>
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h5 class="panel-title">FIRMA ELECTRÓNICA</h5>
                      </div>
                      <div class="panel-body">
                        <div class="col-sm-6">
                          <div class="form-group input-group-sm">
                            <select name="rutaFirma" class="form-control" required>
                              <option value="">Seleccione firma a usar</option>
                              <?php
                        ...
                        <div class="col-sm-6">
                          <div class="form-group input-group-sm">
                            <input type="password" class="form-control" name="passFirma" placeholder="Contraseña de la firma" required>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" role="dialog" aria-labelledby="searchModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="searchModalLabel">Buscar por Producto</h4>
          </div>
          <div class="modal-body">
            <div class="table-responsive">
    ...
    <script src="<?php echo BASEURL ?>asset/js/DataTables/dataTables.min.js"></script>
    <script src="<?php echo BASEURL ?>asset/js/typeahead.jquery.min.js"></script>
    <script type="text/javascript">
      function calcularSubtotal(indexItem) {
        let codRef = $('[name="refe[0][CodRef]"]').val();
