...
<html lang="es">
  <head>
    <title>DTE Chile | Orden de Compra Venta</title>
    <!-- BEGIN META -->
    <meta charset="utf-8">
          ...
          <section>
            <div class="section-header">
              <ol class="breadcrumb">
                ...
                <li class="active">Orden de Compra Electronica</li>
              </ol>
            </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="shadow">
                      ...
                      <br/>
                      <div class="row">
                        <input type="hidden" name="TipoDTE" value="33">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group input-group-sm">
                          <input type="text" class="form-control" name="RUTSocilita" placeholder="RUT solicita (Opcional)" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <tbody>
                <?php foreach ($listaProductos as $producto): ?>
                  <tr>
                    ...
                    <td><a class="btn ink-reaction btn-primary btn-xs selectCliente" id="<?php echo $producto['codigo'] ?>">Usar</a></td>
                  </tr>
                <?php endforeach ?>
              </tbody>
            </table>
