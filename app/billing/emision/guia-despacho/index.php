...
<html lang="es">
  <head>
    <title>DTE Chile | Guia de Despacho</title>
    <!-- BEGIN META -->
    <meta charset="utf-8">
              ...
              <div class="col-lg-offset-1 col-md-11 col-sm-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="shadow">
                      ...
                      <br/>
                      <div class="row">
                        <input type="hidden" name="TipoDTE" value="<?php echo $TipoDTE ?>">
                        ...
                        <div class="col-xs-6 col-sm-3 col-sm-push-6 text-center">
                          <div class="well well-sm">
                            <strong>RUT <?php echo $datos['rut'] ?></strong><br/>
                            ...
                            <input type="hidden" name="rutaFolio" value="<?php echo 'client/folio/52/52.xml' ?>">
                             <!--
                            <input type="hidden" name="Folio" value="<?php echo $datosFolio['folio_actual'] ?>">
                ...
                <div class="panel-heading">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group input-group-sm">
                          <input type="text" class="form-control" name="RUTSocilita" placeholder="RUT solicita" />
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      <div class="row">
                        ...
                        <div class="col-sm-4 text-center">
                          <div class="input-group input-group-sm">
                            <label class="input-group-addon">Indicador de traslado</label>
                              <select class="form-control" name="IndTraslado" required>
                  ...
                  <div class="panel-body">
                    <div id="item">
                      <div class="row">
                          <div class="col-sm-2">
                            <div class="form-group input-group-sm">
                              <input type="text" class="form-control" name="item[0][VlrCodigo]" placeholder="Codigo" />
                          </div>
                        </div>
                        <div class="col-sm-10">
                          <div class="form-group input-group-sm">
                      ...
                      <div class="row">
                        <div class="col-sm-2">
                          <div class="form-group input-group-sm">
                            <input type="text" max="999999999999" maxlength="12" class="form-control" name="item[0][QtyItem]" placeholder="Cantidad" required/>
                          </div>
                        </div>
                        <div class="col-sm-2">
                          <div class="form-group input-group-sm">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group input-group-sm">
                            <select name="rutaFirma" class="form-control" required>
                              <option  value="Sin firma" selected="selected">Seleccione firma a usar</option>
                              <?php
...
<div class="modal fade" id="searchModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
  ...
  $(document).ready(function(){
    ...
    ++count_item;
    $('#item').append(  '<div id="nueva_item' +count_item+ '">' +
                        '  <div class="row">' +
                        '      <div class="col-sm-2">' +
                        '        <div class="form-group input-group-sm">' +
                        '          <input type="text" class="form-control" name="item['+ count_item +'][VlrCodigo]" placeholder="Codigo" />' +
                        '      </div>' +
                        '    </div>' +
                        '    <div class="col-sm-10">' +
                        '      <div class="form-group input-group-sm">' +
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $('#checkbox_referencias').click(function(){
        if($(this).is(':checked')){
...
$(document).ready(function() {
    $('#dttClientes, #dttProductos').DataTable({
        'language': {
