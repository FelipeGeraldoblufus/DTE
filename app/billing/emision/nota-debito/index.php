...
<html lang="es">
  <head>
    <title>DTE Chile | Nota de Débito</title>
    <!-- BEGIN META -->
    <meta charset="utf-8">
                ...
                <div class="card-body">
                  <form class="form-horizontal" action="../generar.php" method="post" autocomplete="off">
                    <div class="shadow">
                      ...
                      <br/>
                      <div class="row">
                        <input type="hidden" name="TipoDTE" value="56">
                        ...
                        <div class="col-xs-6 col-sm-3 col-sm-push-6 text-center">
                          <div class="well well-sm">
                            ...
                            <input type="hidden" name="rutaFolio" value="<?php echo 'client/folio/56/56.xml' ?>">
                          </div>
                        </div>
                      </div>
                    </div>
