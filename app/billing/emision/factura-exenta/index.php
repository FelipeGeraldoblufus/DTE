...
<html lang="es">
  <head>
    <title>DTE Chile | Factura Electronica Exenta</title>
    <!-- BEGIN META -->
    <meta charset="utf-8">
          ...
          <section>
            <div class="section-header">
              <ol class="breadcrumb">
                ...
                <li class="active">Factura Electronica Exenta</li>
              </ol>
            </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="shadow">
                      ...
                      <br/>
                      <div class="row">
                        <input type="hidden" name="TipoDTE" value="34">
                        ...
                        <div class="col-xs-6 col-sm-3 col-sm-push-6 text-center">
                          <div class="well well-sm">
                            ...
                            <input type="hidden" name="rutaFolio" value="<?php echo 'client/folio/34/34.xml' ?>">
                            <!--
                            <input type="hidden" name="Folio" value="<?php echo $datosFolio['folio_actual'] ?>">
