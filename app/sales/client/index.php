...
<html lang="es">
<head>
  <title>DTE Chile | Clientes</title>
  <!-- BEGIN META -->
  <meta charset="utf-8">
      ...
      <section>
        ...
        <div class="section-body">
          <div class="col-lg-offset-1 col-md-10 col-sm-12">
            ...
            <div class="card">
              <div class="card-body">
                <?php if (isset($listaCliente) && !empty($listaCliente)): ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="sendForm" autocomplete="off">
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" id="rut" name="rut" class="form-control" maxlength="12" oninput="formatRut(this)" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
            ...
            <div class="form-group">
              <label for="">Correo Envio</label>
              <input type="text" name="correo_envio" class="form-control">
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="sendForm" autocomplete="off">
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" id="rut_edit" name="rut_edit" class="form-control" maxlength="12" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
            ...
            <div class="form-group">
              <label for="">Correo Envio</label>
              <input type="text" name="correo_envioedit" class="form-control">
            </div>
    ...
    $(document).on('click', '.update', function(){
      ...
      $.ajax({
        ...
        success:function(data)
        {
          ...
          $('[name="correo_envioedit"]').val(data.correo_envio);
