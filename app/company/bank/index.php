        ...
        <div class="section-body">
          <div class="col-lg-offset-1 col-md-10 col-sm-12">
            ...
            <div class="btn-group btn-group-justified" role="group" aria-label="Justified button group">
              <a href="javascript:history.back()" class="btn btn-default-dark" role="button"><i class="fa fa-arrow-left"></i> Volver</a>
              <a class="btn btn-primary" role="button">Bancos</a>
              <a href="<?php echo BASEURL.'app/accountType' ?>" class="btn btn-default-dark" role="button">Tipos de Cuentas</a>
            </div>

            <div class="card">
              <div class="card-body">
                <?php if (isset($listaBanco) && !empty($listaBanco)): ?>
                  ...
                  <tbody>
                    <?php foreach ($listaBanco as $banco): ?>
                      <tr>
                        ...
                        <td class="text-right">
                          <a class="btn btn-icon-toggle update" href="javascript:void(0)" id="<?php echo $banco['id'] ?>" data-toggle="tooltip" data-placement="top" data-original-title="Editar"><i class="fa fa-pencil"></i></a>
                          <a class="btn btn-icon-toggle delete" href="javascript:void(0)" id="<?php echo $banco['id'] ?>" data-toggle="tooltip" data-placement="top" data-original-title="Eliminar"><i class="fa fa-trash-o"></i></a>  
                        </td>
                      </tr>
                    <?php endforeach ?>
                  </tbody>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form autocomplete="off" class="sendForm">
            <div class="form-group">
              <label for="banco_edit">Nombre Banco</label>
              <input type="text" name="banco_edit" id="banco_edit" class="form-control">
            </div>
          </div>
          <div class="modal-footer">
    ...
    $(document).on('click', '.update', function(){
      ...
      $.ajax({
        ...
        success:function(data)
        {
          $('#updModal').modal('show');
          $('[name="id"]').val(id);
          $('[name="banco_edit"]').val(data.banco);
        }
      })
    });
