...
<html lang="es">
<head>
  <title>DTE Chile | Tipos de Cuentas</title>
  <!-- BEGIN META -->
  <meta charset="utf-8">
    ...
    <div id="content">
      <section>
        <div class="section-header">
          <ol class="breadcrumb">
            <li><a href="<?php echo BASEURL ?>app/company/">Empresa</a></li>
            <li class="active">Tipos de Cuentas</li>
          </ol>
        </div>
        ...
        <div class="section-body">
          <div class="col-lg-offset-1 col-md-10 col-sm-12">
            ...
            <div class="card">
              <div class="card-body">
                <?php if (isset($listaTipoCuenta) && !empty($listaTipoCuenta)): ?>
                <table id="dttTipoCuenta" class="table table-hover">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    <?php foreach ($listaTipoCuenta as $tipo): ?>
                      <tr>
                        ...
                        <td class="text-right">
                          <a class="btn btn-icon-toggle update" href="javascript:void(0)" id="<?php echo $tipo['id'] ?>" data-toggle="tooltip" data-placement="top" data-original-title="Editar"><i class="fa fa-pencil"></i></a>
                          <a class="btn btn-icon-toggle delete" href="javascript:void(0)" id="<?php echo $tipo['id'] ?>" data-toggle="tooltip" data-placement="top" data-original-title="Eliminar"><i class="fa fa-trash-o"></i></a>  
                        </td>
                      </tr>
                    <?php endforeach ?>
                  </tbody>
        ...
        <div class="modal-body">
          <form autocomplete="off" class="sendForm">
            <div class="form-group">
              <label for="tipo">Nombre TipoCuenta</label>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form autocomplete="off" class="sendForm">
            <div class="form-group">
              <label for="tipo_edit">Nombre TipoCuenta</label>
              <input type="text" name="tipo_edit" id="tipo_edit" class="form-control">
            </div>
          </div>
          <div class="modal-footer">
