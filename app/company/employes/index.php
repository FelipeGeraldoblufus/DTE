...
$Permiso = new Permiso();
$Empresa = new Empresa();
$listaEmpleado = $Empleado->listaEmpleado();
...
<html lang="es">
<head>
  <title>DTE Chile | Empleados Empresa</title>
  <!-- BEGIN META -->
  <meta charset="utf-8">
      ...
      <section>
        ...
        <div class="section-header">
          <ol class="breadcrumb">
            ...
            <li class="active">Panel de Empleados</li>
          </ol>
        </div>
        ...
        <div class="section-body">
          <div class="col-lg-offset-1 col-md-10 col-sm-12">
            ...
            <div class="card">
              <div class="card-body">
                <?php if (isset($listaEmpleado) && !empty($listaEmpleado)): ?>
                <table id="dttEmpleados" class="table table-hover">
                  <thead>
                    <tr>
                      <th>Foto</th>
                      <th>Nombre</th>
                  ...
                  <tbody>
                    <?php foreach ($listaEmpleado as $usuario): ?>
                      <tr>
    ...
    $(document).on('click', '.delete', function(){
      ...
      $.ajax({
        ...
        success:function(data)
        {
          $('#delModal').modal('show');
          $('[name="id"]').val(id);
          $('#valor').html(data.nombre+' '+data.apellido);
        }
      })
    });
  </script>
