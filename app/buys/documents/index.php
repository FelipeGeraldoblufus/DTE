...
$listaDocumento = $IngresoDocumento->listaDocumento('Compra');
?>
                ...
                <div class="card">
                  <div class="card-body">
                  	...
                  	<table id="dttCuentas" class="table table-hover">
                          ...
                          <?php $rznsocProveedor = $Proveedor->rznsocProveedor($documento['proveedor_rut']); ?>
				                  <tr>
                            <td><?php echo '<strong>'.$documento['proveedor_rut'].'</strong> '.$rznsocProveedor; ?></td>
                            <td>
