          ...
          <section>
            <div class="section-header">
              <ol class="breadcrumb">
                ...
                <li><a href="<?php echo BASEURL ?>app/buys/documents/">Documentos</a></li>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group input-group-sm">
                            <select name="Acteco" class="form-control">
                              <?php foreach ($acteco as $key): ?>
                              <?php if ($datos['acteco'] == $key["codigo"]): ?>
              ...
              <tbody>
                <?php foreach ($listaProveedor as $proveedor): ?>
                  <tr>
                    ...
                    <td><?php echo $proveedor['rznsoc'] ?></td>
                    <td><?php echo $proveedor['giro'] ?></td>
                    <td><a class="btn ink-reaction btn-primary btn-xs selectCliente" id="<?php echo $proveedor['rut'] ?>">Usar</a></td>
                  </tr>
                <?php endforeach ?>
              </tbody>
            </table>
