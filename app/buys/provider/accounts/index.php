...
if (isset($_GET['id']) && !empty($_GET['id'])) {
  ...
  $getProveedor = $Proveedor->getProveedor($rut);
  $listaCuenta = $CuentaProveedor->listaCuenta($rut);
...
<html lang="es">
  <head>
    <title>DTE Chile | Cuentas Proveedores</title>
    <!-- BEGIN META -->
    <meta charset="utf-8">
          ...
          <section>
            <div class="section-header">
              <ol class="breadcrumb">
                ...
                <li><a href="<?php echo BASEURL ?>app/buys/provider/">Proveedores</a></li>
                <li class="active">Cuentas Proveedores</li>
              </ol>
            </div>
