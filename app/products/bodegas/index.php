      ...
      <section>
        ...
        <div class="section-body">
          <div class="col-lg-offset-1 col-md-10 col-sm-12">
            ...
            <div class="card">
              <div class="card-body">
                <?php if (isset($listaBodega) && !empty($listaBodega)): ?>
                <table id="dttBodega" class="table table-hover">
                  <thead>
                    <tr>
                      <th>Bodega</th>
                      <th>Direccion</th>
                  ...
                  <tbody>
                    <?php foreach ($listaBodega as $bodega): ?>
                      <tr>
                        ...
                        <td class="text-right">
                          <a class="btn btn-icon-toggle update" href="javascript:void(0)" id="<?php echo $bodega['id'] ?>" data-toggle="tooltip" data-placement="top" data-original-title="Editar"><i class="fa fa-pencil"></i></a>
                          <a class="btn btn-icon-toggle delete" href="javascript:void(0)" id="<?php echo $bodega['id'] ?>" data-toggle="tooltip" data-placement="top" data-original-title="Eliminar"><i class="fa fa-trash-o"></i></a>  
                        </td>
                      </tr>
                    <?php endforeach ?>
                  </tbody>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form autocomplete="off" class="sendForm">
            ...
            <div class="form-group">
              <label id="direccion">Direccion Bodega</label>
              <input type="text" name="direccion" id="direccion" class="form-control">
            </div>
            <div class="form-group">
              <label for="telefono">Telefono Bodega</label>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form autocomplete="off" class="sendForm">
            <div class="form-group">
              <label for="bodega_edit">Nombre Bodega</label>
              <input type="text" name="bodega_edit" id="bodega_edit" class="form-control">
            </div>
            <div class="form-group">
              <label id="direccion_edit">Direccion Bodega</label>
              <input type="text" name="direccion_edit" id="direccion_edit" class="form-control">
            </div>
            <div class="form-group">
              <label for="telefono_edit">Telefono Bodega</label>
    ...
    $(document).on('click', '.update', function(){
      ...
      $.ajax({
        ...
        success:function(data)
        {
          $('#updModal').modal('show');
          $('[name="id"]').val(id);
          $('[name="bodega_edit"]').val(data.bodega);
